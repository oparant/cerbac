 ...
 * </p>
 * <ul>
 *   <li>{@link edu.utd.cse.cerbac.cerbac.WhenLink#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @see edu.utd.cse.cerbac.cerbac.CerbacPackage#getWhenLink()
 * @model
 * @generated
 */
public interface WhenLink extends EObject {
	 ...
	 * @see edu.utd.cse.cerbac.cerbac.CerbacPackage#getWhenLink_Base_Association()
	...
	/**
	 * Sets the value of the '{@link edu.utd.cse.cerbac.cerbac.WhenLink#getBase_Association <em>Base Association</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
