...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>What Link</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.utd.cse.cerbac.cerbac.impl.WhatLinkImpl#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhatLinkImpl extends MinimalEObjectImpl.Container implements WhatLink {
	/**
	...
	protected EClass eStaticClass() {
		return CerbacPackage.Literals.WHAT_LINK;
	}
		...
		if (base_Association != null && base_Association.eIsProxy()) {
			...
			if (base_Association != oldBase_Association) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CerbacPackage.WHAT_LINK__BASE_ASSOCIATION, oldBase_Association, base_Association));
			}
		}
	...
	public void setBase_Association(Association newBase_Association) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CerbacPackage.WHAT_LINK__BASE_ASSOCIATION, oldBase_Association, base_Association));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CerbacPackage.WHAT_LINK__BASE_ASSOCIATION:
