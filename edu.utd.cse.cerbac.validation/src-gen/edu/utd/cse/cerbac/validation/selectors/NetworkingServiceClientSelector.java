 ...
 * @generated
 */
public class NetworkingServiceClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "NetworkingService"); //$NON-NLS-1$
	}
}
