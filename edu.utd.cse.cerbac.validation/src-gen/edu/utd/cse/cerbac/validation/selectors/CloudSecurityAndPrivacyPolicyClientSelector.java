 ...
 * @generated
 */
public class CloudSecurityAndPrivacyPolicyClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "CloudSecurityAndPrivacyPolicy"); //$NON-NLS-1$
	}
}
